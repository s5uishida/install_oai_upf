...
### Apply the patch to enable Framed Routing in eBPF/XDP mode
...
To enable Framed Routing in eBPF/XDP or Simple Switch mode, change the configuration file as follows.
```diff
...
- [2026.09.19] Updated as follows.
  ...
  - Created [Fix some build errors](https://github.com/s5uishida/install_oai_upf/blob/main/patches/fix_build_error.patch) patch. This patch includes [this file](https://github.com/openairinterface/oai-cn5g-common-build/blob/ubuntu_24_support_test/installation/build_helper.fb_folly).
